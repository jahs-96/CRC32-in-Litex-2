...
VL_INLINE_OPT void Vsim_VexRiscv::_sequent__TOP__sim__VexRiscv__28(Vsim__Syms* __restrict vlSymsp) {
    ...
    if (vlSymsp->TOP__sim.__Vcellinp__VexRiscv__reset) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__toplevel_dataCache_1_io_mem_cmd_rValidN = 1U;
    } else {
        if (vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_mem_cmd_valid) {
            vlSymsp->TOP__sim__VexRiscv.__PVT__toplevel_dataCache_1_io_mem_cmd_rValidN = 0U;
        }
    ...
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__when_CsrPlugin_l1719) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__execute_CsrPlugin_readInstruction = 0U;
    }
    ...
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__when_CsrPlugin_l1719) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__execute_CsrPlugin_writeInstruction = 0U;
    }
...
VL_INLINE_OPT void Vsim_VexRiscv::_sequent__TOP__sim__VexRiscv__31(Vsim__Syms* __restrict vlSymsp) {
    ...
    if (((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__writeBack_arbitration_isValid) 
        ...
        VL_SHIFTL_WWI(66,66,6, __Vtemp25, __Vtemp24, 0x20U);
